...
db.addCollection('dogs', [
  { name: 'Pluto', color: 'White', age: 3 },
  { name: 'Rex', color: 'Gold', age: 11 },
  { name: 'Kex', color: 'Grey', age: 1 },
]);

db.addCollection('pokemon', [
  { name: 'Pikachu', color: 'Yellow', age: 3 },
  { name: 'Squirtel', color: 'Gold', age: 11 },
  { name: 'Slowpoke', color: 'Grey', age: 1 },
]);
